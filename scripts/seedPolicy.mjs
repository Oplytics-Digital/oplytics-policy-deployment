...
async function seed() {
  ...
  if (existingPlans.length > 0) {
    ...
    const projData = [
      { code: "P1.1", name: "Middleton foam scrap reduction", description: "Root-cause analysis and process parameter optimisation on MID-FM1 and MID-FM2 foam-making machines to reduce off-spec blocks", ownerName: "Robin Parry", status: "on-track", progress: 62, startDate: "2026-01-15", endDate: "2026-06-30", category: "cost", sortOrder: 1 },
      ...
      { code: "P1.4", name: "Poznan mattress line ramp-up", description: "Commission MPL-ML1 mattress assembly line in Poznan, train local operators, and achieve 80% utilisation within 6 months", ownerName: "Omar Hoek", status: "at-risk", progress: 28, startDate: "2026-03-01", endDate: "2026-09-30", category: "delivery", sortOrder: 4 },
